...
namespace Framework.Application.Utility
{
    public static class Tools
    {
        ...
        public static DateTime ToGeorgianDateTimeFull(this string persianDate)
        {
            ...
            var hour = Convert.ToInt32(persianDate.Substring(13, 2));
            var minute = Convert.ToInt32(persianDate.Substring(16, 2));
            return new DateTime(year, month, day,hour,minute,00, new PersianCalendar());
        }
        ...
        public static DateTime ToGeorgianDateTimeSpecificDayStart(this DateTime persianDate)
        {
            return new DateTime(persianDate.Year, persianDate.Month, persianDate.Day, 00, 00, 00, new PersianCalendar());
        }
        
        public static DateTime ToGeorgianDateTimeSpecificDayStart(this string persianDate)
        {
            persianDate = persianDate.ToEnglishNumber();
            var year = Convert.ToInt32(persianDate.Substring(0, 4));
            var month = Convert.ToInt32(persianDate.Substring(5, 2));
            var day = Convert.ToInt32(persianDate.Substring(8, 2));
            return new DateTime(year, month, day,00,00,00, new PersianCalendar());
        }
        
        public static DateTime ToGeorgianDateTimeSpecificDayEnd(this DateTime persianDate)
        {
            return new DateTime(persianDate.Year, persianDate.Month, persianDate.Day, 23, 59, 59, new PersianCalendar());
        }
        
        public static DateTime ToGeorgianDateTimeSpecificDayEnd(this string persianDate)
        {
            persianDate = persianDate.ToEnglishNumber();
            var year = Convert.ToInt32(persianDate.Substring(0, 4));
            var month = Convert.ToInt32(persianDate.Substring(5, 2));
            var day = Convert.ToInt32(persianDate.Substring(8, 2));
            return new DateTime(year, month, day,23,59,59, new PersianCalendar());
        }
